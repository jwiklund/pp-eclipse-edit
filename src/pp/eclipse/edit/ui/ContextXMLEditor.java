...
public class ContextXMLEditor extends MultiPageEditorPart implements IResourceChangeListener
{

	private StructuredTextEditor editor;

	public ContextXMLEditor() {
		super();
	...
	void createPage0() {
		try {
			...
			setPageText(index, editor.getTitle() + "test");
